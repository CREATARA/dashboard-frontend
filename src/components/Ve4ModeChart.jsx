...
const  Ve4ModeChart= ({ isOpen, onClose }) => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get('https://dashboard-backend-h8qz.onrender.com/api/data/ve4/analytics/mode-distribution');
