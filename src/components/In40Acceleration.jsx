// src/components/In40Acceleration.jsx
...
// Helper to calculate speed in meters per second
...
const In40Acceleration = ({ isOpen, onClose }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const response = await axios.post('https://dashboard-backend-h8qz.onrender.com/api/data/in40/analytics/acceleration', body);
    ...
    const handleDownloadReport = () => {
        ...
        html2canvas(chartElement).then((canvas) => {
            ...
            pdf.setFontSize(18);
            pdf.text('Acceleration Impact Report', 14, 22);
            pdf.setFontSize(11);
            ...
            autoTable(pdf, {
                startY: 150,
                head: [['Time', 'SOC (%)', 'Acceleration (m/s²)']],
            ...
            pdf.save('acceleration_report.pdf');
            setLoading(false);
        });
    };
    ...
    const handleDownloadCSV = () => {
        ...
        const csvData = chartData.map(d => ({
            ...
            "SOC (%)": d.soc,
            "Acceleration (m/s^2)": d.acceleration
        }));
            ...
            <div className="bg-primary p-6 rounded-2xl shadow-lg w-full max-w-5xl">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <div className="flex items-center gap-4">
                        <button onClick={handleDownloadCSV} className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg" disabled={loading || chartData.length === 0}>Download CSV</button>
                        <button onClick={handleDownloadReport} className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg" disabled={loading || chartData.length === 0}>Download Report (PDF)</button>
