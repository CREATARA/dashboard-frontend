...
// src/components/In40BatteryHealth.jsx
...
const In40BatteryHealth = ({ isOpen, onClose }) => {
    ...
    const handleDownloadReport = () => {
        ...
        html2canvas(chartElement).then((canvas) => {
            ...
            pdf.setFontSize(18);
            pdf.text('Battery Health Report (SOC & Temp vs. Time)', 14, 22);
            pdf.setFontSize(11);
            ...
            pdf.save('battery_health_report.pdf');
            setLoading(false);
        });
    };
    ...
    const handleDownloadCSV = () => {
        ...
        link.setAttribute('download', 'battery_health_data.csv');
