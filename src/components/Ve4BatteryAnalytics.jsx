...
const Ve4BatteryAnalytics = ({ isOpen, onClose }) => {
                    ...
                    {loading ? (
                        ...
                        <ResponsiveContainer>
                            <LineChart data={chartData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                                ...
                                <Line yAxisId="right" type="monotone" dataKey="btemp" name="Battery Temp (°C)" stroke="#f87171" dot={false} activeDot={{ r: 8 }} isAnimationActive={false} />
                            </LineChart>
                        </ResponsiveContainer>
                    )}
                </div>
...
export default Ve4BatteryAnalytics;